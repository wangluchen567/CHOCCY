...
def Solve_Ackley():
    ...
    algorithm = SA(pop_size=1, max_iter=10000, show_mode='obj')
...
def Solve_KP():
    ...
    algorithm = SA(pop_size=1, max_iter=10000, perturb_prob=1 / 100, show_mode='obj')
    algorithm.solve(problem)
    best, best_obj, best_con = algorithm.get_best()
    print(best_obj)
    algorithm.plot_scores()
...
def Solve_TSP():
    problem = TSP(30)
    algorithm = SA(pop_size=1, max_iter=10000, perturb_prob=0.5, show_mode='obj')
    algorithm.solve(problem)
    best, best_obj, best_con = algorithm.get_best()
    print(best_obj)
    algorithm.plot_scores()
