...
def setup_logger(log_path=None, to_file=True, to_console=True, timestamp=False, singleton=False):
    """
    配置日志记录器
    :param log_path: 输出日志的文件路径
    :param to_file: 是否输出日志到指定路径
    :param to_console: 是否输出日志到控制台
    :param timestamp: 日志输出是否有时间戳信息
...
class AppLogger:
    ...
    def __init__(self, log_path=None, to_file=True, to_console=True, timestamp=False, singleton=False):
        """
        支持单例模式的日志类
        :param log_path: 输出日志的文件路径
        :param to_file: 是否输出日志到指定路径
