...
在开始优化之前，首先需要定义一个问题。关于如何自定义问题的详细内容，请参见[使用指南](./References/GUIDE.md)中的`快速开始`部分
...
考虑到一些伙伴会使用使用本项目求解旅行商问题(TSP)，这里给出TSPLIB数据集的优化结果(部分中小规模)

| Instance | BKS   | GA    | SA    | ACO   | HGA-TSP | FI    | GFLS  | Gap(%)(GFLS) |
|----------|-------|-------|-------|-------|---------|-------|-------|--------------|
| gr17     | 2085  | 2085  | 2098  | 2085  | 2085    | 2096  | 2085  | 0.00         |
| gr24     | 1272  | 1272  | 1341  | 1272  | 1272    | 1361  | 1272  | 0.00         |
| eil51    | 426   | 440   | 459   | 441   | 428     | 451   | 426   | 0.00         |
| eil76    | 538   | 601   | 591   | 565   | 570     | 607   | 538   | 0.00         |
| berlin52 | 7542  | 7929  | 7959  | 7662  | 7971    | 8118  | 7542  | 0.00         |
| KroA100  | 21282 | 26063 | 22413 | 22455 | 22977   | 23373 | 21292 | 0.04         |
| KroB100  | 22141 | 27124 | 24662 | 23155 | 22733   | 23958 | 22157 | 0.07         |
| KroC100  | 20749 | 27419 | 25733 | 21627 | 21927   | 21817 | 20749 | 0.00         |

**说明：**
- **BKS**：Best Known Solution，目前所知的最优解
- **Gap(%) (GFLS)**：GFLS算法与BKS之间的差距百分比。
- **参数设置**：`pop_size=100`, `max_iter=1000`（为了算法尽可能收敛）
- **随机性**：除FI和GFLS算法以外，其他算法均具有一定的随机性，再次优化的结果会略有不同
